...
This project focuses on analyzing retail sales data using SQL to extract business insights from transactional records. It involves designing a structured relational database, performing data cleaning, and writing analytical queries to explore sales trends, customer behavior, and product performance.
